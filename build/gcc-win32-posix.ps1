...
$BUILD_VERSION = ((Get-Content "C:\gcc.txt" -Raw) -Split "/brechtsanders/winlibs_mingw/releases/download/(.+)/winlibs")[1]
...
$BUILD_FILE += (((Get-Content "C:\gcc.txt" -Raw) -Split "<a href=`"/brechtsanders/winlibs_mingw/releases/download/${BUILD_VERSION}/${BUILD_FILE}")[3] -Split ".7z")[0]
...
curl -o "C:\mingw.7z" "https://github.com/brechtsanders/winlibs_mingw/releases/download/${BUILD_VERSION}/${BUILD_FILE}.7z"
7z x c:\mingw.7z -oc:\
